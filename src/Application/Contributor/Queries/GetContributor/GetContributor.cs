...
public record GetContributorQuery(int id) : IRequest<ApplicationUser>
{
...
public class GetContributorQueryHandler : IRequestHandler<GetContributorQuery, ApplicationUser>
{
    ...
    public GetContributorQueryHandler(IApplicationDbContext context, IContributorService contributorService, IMapper mapper)
    {
        _context = context;
