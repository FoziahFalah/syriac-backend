...
public interface IApplicationRoleService
{
    ...
    Task<List<ApplicationRole>?> GetRolesAsync(List<int> roleId, CancellationToken cancellationToken);
    Task<Result> CreateAsync(ApplicationRole role, CancellationToken cancellationToken);
    Task<Result> UpdateRolePermissions(int roleId,string permissionIds, CancellationToken cancellationToken);
