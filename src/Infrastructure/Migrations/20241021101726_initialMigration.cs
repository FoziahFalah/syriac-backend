    ...
    public partial class initialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DateFromats", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExcerptDates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Publications_Sources_SourceId",
                        column: x => x.SourceId,
                        principalTable: "Sources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SourceInroductionEditors_Sources_SourceId",
                        column: x => x.SourceId,
                        principalTable: "Sources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExcerptTexts_LanguageId",
                table: "ExcerptTexts",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_ExcerptTexts_ReviewerId",
                table: "ExcerptTexts",
                column: "ReviewerId");

            migrationBuilder.CreateIndex(
                name: "IX_ExcerptTexts_TranslatorId",
                table: "ExcerptTexts",
                column: "TranslatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Footnotes_CommenterId",
                table: "Footnotes",
                column: "CommenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sources_AuthorId",
                table: "Sources",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_Sources_CenturyId",
                table: "Sources",
                column: "CenturyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sources_IntroductionEditorId",
                table: "Sources",
