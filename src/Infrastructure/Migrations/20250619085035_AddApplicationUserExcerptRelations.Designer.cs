...
namespace SyriacSources.Backend.Infrastructure.Migrations
{
    ...
    [Migration("20250619085035_AddApplicationUserExcerptRelations")]
    partial class AddApplicationUserExcerptRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SyriacSources.Backend.Domain.Entities.ApplicationRolePermission", b =>
                {
                    ...
                    b.HasIndex("ApplicationRoleId", "ApplicationPermissionId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SyriacSources.Backend.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("IdentityApplicationUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SyriacSources.Backend.Domain.Entities.ExcerptText", b =>
                {
                    b.HasOne("SyriacSources.Backend.Domain.Entities.ApplicationUser", "Editor")
                        .WithMany("EditedExcerpts")
                        .HasForeignKey("EditorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SyriacSources.Backend.Domain.Entities.Excerpt", "Excerpt")
                        .WithMany("ExcerptTexts")
                        .HasForeignKey("ExcerptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SyriacSources.Backend.Domain.Entities.ApplicationUser", b =>
                {
                    b.Navigation("EditedExcerpts");

                    b.Navigation("ReviewedExcerpts");

                    b.Navigation("TranslatedExcerpts");
                });

            modelBuilder.Entity("SyriacSources.Backend.Domain.Entities.Excerpt", b =>
                {
                    b.Navigation("ExcerptComments");

                    b.Navigation("ExcerptDates");

                    b.Navigation("ExcerptTexts");
                });
